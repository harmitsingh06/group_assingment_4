package com.glearning.employee.security;
...
import com.glearning.employee.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/api/user", "/api/role").hasAuthority("ADMIN")
				...
				.antMatchers(HttpMethod.GET, "/api/employees").hasAnyAuthority("USER", "ADMIN").anyRequest()
